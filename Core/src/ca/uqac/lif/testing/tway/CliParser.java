...
public class CliParser
{
   ...
   * 
   * @param cli
   *          The array of strings (typically, the <code>args</code> argument from
   *          <code>main()</code>
   * @return A map from parameter's <em>short</em> names to their values, or
   *         <code>null</code> if the parsing failed
   */
  ...
  private boolean handleEndOfArgument(Argument current_argument, String current_value,
      ArgumentMap parsed)
  {
    if (current_argument != null)
    {
   ...
   * 
   * @param header
   *          A string to display before the help
   * @param out
   *          The print stream to send the output to (typically
   ...
   * <ul>
   * <li>A "short" name, such as <tt>-s</tt>. Short names generally have a single
   * symbol and are prefixed with a single dash</li>
   * <li>A "long" name, such as <tt>--server</tt>. Long names have multiple
   * symbols and are prefixed with two dashes</li>
  ...
  public static class Argument
  {
    ...
    public boolean equals(Object o)
    {
      ...
      return ((m_shortName != null && a.m_shortName != null
          ...
          || (m_longName != null && a.m_longName != null
              && m_longName.compareTo(a.m_longName) == 0));
    }
  ...
  public static class ArgumentMap
  {
     ...
     * 
     * @param name
     *          The <em>short</em> name of the argument
     * @return The value, or <code>null</code> if the argument is not present
     */
     ...
     * 
     * @param name
     *          The argument's <em>short</em> name
     * @param value
     *          Its value
